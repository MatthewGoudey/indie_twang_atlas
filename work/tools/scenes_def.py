...
SCENES = [
 ...
 ("New Orleans", "New Orleans, LA", "1995–", "New West, ATO", "Hurray for the Riff Raff, The Deslondes, Esther Rose, The Lostines, Sam Doores, Riley Downing, Luke Winslow-King, Sarah Quintana, Pat Reedy", "Old-time, folk and honky-tonk revival that grew out of the street-busking circuit; the Deslondes' members and their friends turn up on each other's records."),
